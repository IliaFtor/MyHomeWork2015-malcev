namespace saod_9
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            Stopwatch rbTreeStopwatch = new Stopwatch()
            {

            };
            rbTreeStopwatch.Start();
            fill_rbtree("the");
            rbTreeStopwatch.Stop();
            ...
            Console.WriteLine($"RBTree execution time: {rbTreeStopwatch.ElapsedMilliseconds} ms");
            Console.WriteLine($"Trie execution time: {trieStopwatch.ElapsedMilliseconds} ms");
